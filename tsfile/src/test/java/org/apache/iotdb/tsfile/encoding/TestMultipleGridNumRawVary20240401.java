...
public class TestMultipleGridNumRawVary20240401 {
...
//    }
  ...
  public static void main(String[] args) throws IOException {
    ...
    output_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\result_evaluation\\vary_parameter\\vary_outlier_q\\TY-Fuel_ratio.csv");
    input_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\iotdb_test\\Metro-Traffic"); //2
    output_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\result_evaluation\\vary_parameter\\vary_outlier_q\\Metro-Traffic_ratio.csv");
    input_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\iotdb_test\\Temperature"); //3
    output_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\result_evaluation\\vary_parameter\\vary_outlier_q\\Temperature_ratio.csv");
    input_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\iotdb_test\\Humidity"); //4
    output_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\result_evaluation\\vary_parameter\\vary_outlier_q\\Humidity_ratio.csv");
        ...
        //for (int vary_p = 4; vary_p < 9; vary_p++) {
          ...
          for (int i = 0; i < repeatTime; i++) {
            ...
            for (int repeat = 0; repeat < repeatTime2; repeat++) {
              buffer = ReorderingRegressionEncoder(data, (int) Math.pow(2, 8), 0.02 * vary_p);
