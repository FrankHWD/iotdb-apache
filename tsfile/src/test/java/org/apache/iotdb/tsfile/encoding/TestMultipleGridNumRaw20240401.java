...
public class TestMultipleGridNumRaw20240401 {
...
//    }
  ...
  public static void main(String[] args) throws IOException {
    ...
    output_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\result_evaluation\\compression_ratio\\rr_ratio\\Temperature_ratio.csv");
    input_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\iotdb_test\\Humidity"); //4
    output_path_list.add("E:\\thu\\TimeEncoding\\TestTimeGrid\\result_python\\result_evaluation\\compression_ratio\\rr_ratio\\Humidity_ratio.csv");
      ...
      for (File f : tempList) {
        ...
        for (int i = 0; i < repeatTime; i++) {
          ...
          for (int repeat = 0; repeat < repeatTime2; repeat++) {
            for (int j=4;j<9;j++) {
              buffer = ReorderingRegressionEncoder(data, (int) Math.pow(2,j),0.1);
            }
          }
